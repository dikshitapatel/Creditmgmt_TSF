...
<div class="card">
    <?php echo '<td><img src="imgs/'.$user['Profile_img'].'" class="center"  height="250px" width="250px"></td>';?>
  <h1><?php echo $name; ?></h1>
  <p class="title">Email:  <?php echo $email;?></p>
  <p class="title">Current credit:<?php echo $credit;?></p>
  <div style="margin: 24px 0;">
     </div>
  <p><a href="receiver.php"><button class="button">Transfer Credit To:</button></a></p>
</div>
<!-- jquery -->
